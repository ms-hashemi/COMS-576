...
Dubins path planner sample code (refer to https://github.com/AtsushiSakai/PythonRobotics)
...
def main():
    ...
    start_x, start_y, start_yaw = -1.1992264159550992, -0.5389526943519423, 0.48196054558864887  # [m]

    end_x, end_y, end_yaw = -2.0, -0.5, 0.0  # [m]
